...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--fps", type=int, default=10, help="Requested FPS. Default: 10.")
    parser.add_argument("--warmup", type=int, default=10, help="Frames to discard after opening. Default: 10.")
